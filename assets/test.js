...
showStep(1);
  ...
  const TEST_COPY = {
    ...
    redflags: {
      summaryTitle: "Relationship Red Flags test/Харилцааны эрсдэлийн үнэлгээний товч тайлан",
    ...
    future: {
      summaryTitle: "Future Readiness test/Ирээдүйн чадамжийн үнэлгээний товч тайлан",
    ...
    money: {
    summaryTitle: "Money Mindset test/Мөнгөний сэтгэлгээний үнэлгээний товч тайлан",
  ...
  const CLIFF_REDFLAGS = {
    low: [
      "<p>Таны харилцааны суурь тогтвортой байгаа нь харагдаж байна. Итгэлцэл бий, харилцаа тодорхой хэмжээнд эрүүл яваа гэсэн үг. Гэхдээ энэ нь та хоёрын ирээдүй бүрэн баталгаатай гэсэн үг биш юм. Багахан ан цавуудыг үл тоох үед тэдгээр нь аажмаар томорч, та хоёрын харилцаанд үл үзэгдэх хана болж хувирах боломжтой. Өдөр тутмын жижиг үл ойлголцлууд, баяр талархлаа хэлэлгүй өнгөрөх зуршил, эсвэл “би өөрийгөө тайлбарлах шаардлагагүй” гэсэн хандлагууд аажмаар хуримтлагдсаар итгэлцлийг сийрэгжүүлдэг.</p><p>❗️ Энэ түвшинд хамгийн том эрсдэл бол “бид хоёр зүгээр” гэсэн хийсвэр тайвшрал юм. Учир нь яг энэ үед та хоёр хамгийн амархан урьдчилан сэргийлж, харилцаагаа илүү бат бөх болгох боломжтой байдаг.</p><p>👉 Хэрэв та аль жижиг зуршлууд ирээдүйд red flag болж хувирах эрсдэлтэй мөн тэдгээрийг хэрхэн эерэг үйлдэл болгож өөрчлөх боломжтой талаар илүү дэлгэрэнгүй харахыг хүсвэл, бүрэн тайлангаас үзэх боломжтой.</p>"
    ],
    mid: [
      "<p>Таны харилцаанд хэд хэдэн анхааруулга өгч буй дохио илэрч эхэлжээ. Сунжирсан дуугүйдэл, жижиг шийдвэрийн үеийн үл ойлголцол, хил хязгаарын тодорхой бус байдал зэрэг нь анхны түвшний red flag-ууд юм. Энэ шатанд харилцаа бүрэн нурсан биш ч, анхаарал хандуулахгүй бол итгэлцэл суларч, хайр халамжийн орон зайд үл ойлголцол давамгайлна. Та өөрийгөө заримдаа ганцаардсан, ойлгогдоогүй мэт мэдэрдэг байж болох ба нөгөө талдаа хамтрагч тань “яагаад намайг хүлээж авахгүй байна” гэх далд бухимдал тээж явдаг.</p><p>❗️ Хэрэв энэ шатанд та хоёр хоёулаа ухамсаргүйгээр асуудлыг үл тоовол, ирээдүйд илүү ноцтой хэлбэрийн зөрчил болж хувирна.</p><p>👉 Бид таны хариулт дээр үндэслэн, харилцаанд яг ямар зан төлөв, ямар нөхцөл байдал хамгийн их зөрчил үүсгэж байгаа болон хэрхэн бууруулах алхмуудыг бүрэн тайландаа багтаасан байгаа.</p>"
    ],
    high: [
      "<p>Таны харилцаа өндөр эрсдэлийн түвшинд байна. Хяналт тогтоох оролдлого, доромжлол, айдас төрүүлэх орчин байнга мэдрэгддэг үү? Энэ бол зөвхөн жижиг маргаан биш, харин таны аюулгүй байдал, өөрийн үнэ цэнэ шууд эрсдэлд орж буйг илтгэнэ. Итгэлцэл эвдэрч, зөрчил “хэн ялж, хэн ялагдах вэ” гэсэн тэмцэлд шилжиж, хамт байхын оронд нэгнээ ялан дийлэхийн төлөө өрсөлдөөн болж хувирчээ. Энэ нөхцөлд олон хүн өөрийгөө буруутган, “би л зөв тэвчвэл бүх зүйл дээрдэнэ” гэж боддог ч бодит байдал эсрэгээрээ — илүү их доройтол хүлээж байдаг.</p><p>❗️ Энэ бол яаралтай анхаарал шаардсан үе шат. Хэрэв та яг одоо дорвитой өөрчлөлт хийхгүй бол харилцаа тань зөвхөн уналт руу чиглэнэ. Сэтгэл зүй, ажил мэргэжил, гэр бүлийн амьдрал бүхэлдээ дагаж уруудах эрсдэлтэй.</p><p>👉 Манай тайланд таны өгөгдөлд үндэслэн, ямар red flag хамгийн ноцтой түвшинд байгаа, түүнийг хэрхэн оношлох болон аюулгүй байдлаа хэрхэн хамгаалах алхмуудыг нарийн зааж өгсөн.</p>"
    ],
    severe: [
    "<p>Таны харилцаа маш өндөр эрсдэлтэй түвшинд байна. Доромжлол, хүчирхийлэл, айдас төрүүлэх орчин тогтмол болж хувирсан байж болзошгүй. Энэ нь зөвхөн хайр, итгэлцэл алдагдсан гэсэн үг биш — харин таны сэтгэл зүй, аюулгүй байдал шууд эрсдэлд орсон байна.</p><p>❗️ Энэ шатанд асуудлыг үл тоомсорлох нь таны эрүүл мэнд, амьдралд ноцтой хор уршиг авчирна. Хамгийн түрүүнд өөрийн аюулгүй байдлыг хангах, шаардлагатай бол мэргэжлийн тусламж, дэмжлэг хайх ёстой.</p><p>👉 Тайланд таны харилцаанд яг ямар ноцтой red flag давамгайлж байгаа болон өөрийгөө хамгаалахын тулд авах алхмуудыг нарийвчлан харуулсан.</p>"
  ]
  };
  ...
  const CLIFF_FUTURE = {
    ...
    severe: [
    "<p>Таны оноо маш өндөр эрсдэлтэй гарлаа. Энэ нь таны карьер, ур чадварын ирээдүй бүрэн хамгаалалтгүй болж, өөрчлөлтөд хамгийн их өртөх бүлэгт орсон гэсэн дохио юм. Шинэ технологи, ажлын зах зээлийн өөрчлөлтүүдэд та бэлэн бус, хамгаалалтын системүүд бараг байхгүй байна.</p><p>❗️ Энэ шатанд хойш суух бүр таны боломжууд хаагдаж, ойрын 1–2 жилд та зах зээлээс шахагдах эрсдэлтэй. Яаралтай арга хэмжээ авахгүй бол зөвхөн карьер биш, санхүү, хувийн амьдралд ч томоохон доройтол авчирна.</p><p>👉 Тайланд таны ирээдүйг хамгаалахын тулд яг ямар ур чадваруудыг шуурхай хөгжүүлэх ёстойг шат дараатай харуулсан.</p>"
  ]
  };
  ...
  severe: [
    "<p>Таны санхүүгийн оноо маш өндөр эрсдэлтэй гарлаа. Энэ нь таны мөнгөний урсгал тогтворгүйгээс гадна өрийн дарамт, санхүүгийн буруу зуршил аль хэдийн хяналтаас гарсан гэсэн үг. Та өнөөдөр орлого олж байсан ч маргааш бүхэлдээ өрөнд живэх өндөр магадлалтай.</p><p>❗️ Энэ шатанд асуудлыг хойшлуулах нь хамгийн том эрсдэл юм. Яаралтай төлөвлөгөө зохиож, өрийн дарамтыг бууруулах, зарцуулалтын зуршлаа таслах шаардлагатай.</p><p>👉 Манай тайланд таны хамгийн том алдаа болж буй зуршлуудыг тодорхойлж, эхний 72 цагт хэрэгжүүлэх алхмуудыг багтаасан.</p>"
  ]
  };
  ...
  severe: [
    "<p>Таны оноо маш өндөр эрсдэлтэй түвшинд байна. Энэ нь таны эрч хүч, сэтгэл санаа, бие махбодын бүх систем ноцтой хэмжээнд доройтож буйг илтгэнэ. Өдөр тутмын жижиг ядралт аль хэдийн тогтмол болсон бөгөөд энэ байдал удаан үргэлжилбэл сэтгэл гутрал, архаг өвчин, ажил болон харилцааны том хямралд хүргэх эрсдэл маш өндөр.</p><p>❗️ Энэ шатанд 'би тэснэ' гэж өөрийгөө хуурах нь хамгийн том алдаа болно. Яаралтай амралт авах, мэргэжлийн тусламж эрэлхийлэх, амьдралын хэв маягаа эрс өөрчлөх шаардлагатай.</p><p>👉 Манай тайланд таны хувьд аль хүчин зүйл хамгийн хүчтэйгээр эрч хүчийг сорж байгаа болон яаралтай хэрэгжүүлэх алхмуудыг дэлгэрэнгүй зааж өгсөн.</p>"
  ]
  };
...
const DOMAIN_MAP = {
  burnout: {
  energy: ["q1","q2","q19","q20"],            // Эрч хүч ба сэргэлт
  sleep: ["q5","q12","q14","q15"],            // Нойр
  mood: ["q6","q8","q10","q13","q17"],        // Сэтгэл санаа
  focus: ["q3","q4","q7","q9","q11","q16","q18"] // Төвлөрөл, бүтээмж, харилцаа
},
  redflags: {
  trust: ["q1","q2","q3","q4","q7"],
  respect: ["q5","q6","q8","q9"],
  comms: ["q10","q12","q13","q14"],
  safety: ["q11","q15","q16","q17","q18","q19","q20"]
},
  money: {
  budget: ["q1","q2","q3","q8","q15"],        // төсөв, хэрэглээ, төлөвлөлт
  debt: ["q6","q7","q9","q10","q16"],         // өр, зээл, эрсдэл
  saving: ["q4","q11","q12","q17","q19"],     // хадгаламж, зорилго, санхүүгийн боловсрол
  income: ["q5","q13","q14","q18","q20"]      // орлого, эрсдэл тэсвэр, бизнес, төрөлжилт
},
  future: {
  skills: ["q1","q2","q3","q8","q11","q18"],         // ур чадвар, карьерийн roadmap, шинэ чадвар, lifelong learning
  health: ["q4","q5","q6","q12","q15"],              // эрүүл мэнд, дасгал, сэтгэлзүй, тэнцвэр
  network: ["q7","q9","q13","q16"],                  // сүлжээ, портфолио, ментор, багийн оролцоо
  finance: ["q10","q14","q17","q19","q20"]           // санхүү, Plan B, хөрөнгө оруулалт, цагийн менежмент, санхүүгийн бэлтгэл
}
};
